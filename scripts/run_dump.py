...
# We will use the standard sqlite3 or whatever, but actually we need mysql.
# Since we might not have activated venv in subprocess, let me write a script that points to the venv python directly.
...
with open(r'd:\online-food-ordering\actual_dumper.py', 'w', encoding='utf-8') as f:
    f.write(script)

print("Starting subprocess...")
result = subprocess.run([r"d:\online-food-ordering\.venv\Scripts\python.exe", r"d:\online-food-ordering\actual_dumper.py"], capture_output=True, text=True)
